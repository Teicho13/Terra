...
namespace Terra
{
    ...
    void Renderer::Initialize()
    {
        ...
        s_RendererData.VertexArray->AddAttribute(*s_RendererData.VertexBuffer,{.count = 1, .type = GL_INT  , .normalized = GL_FALSE, .stride = sizeof(QuadVertexData), .offset = (void*)offsetof(QuadVertexData, TextureID)});
    ...
    void Renderer::DrawQuad(const glm::mat4& transform, const glm::vec4& color)
    {
        ...
        for (size_t i = 0; i < quadVertexCount; i++)
        {
            ...
            s_RendererData.QuadVertexDataAdressCopy->TextureID = 0;
    ...
    void Renderer::DrawQuad(const glm::mat4& transform, const Texture& texture)
    {
        ...
        for (size_t i = 0; i < quadVertexCount; i++)
        {
            ...
            s_RendererData.QuadVertexDataAdressCopy->Texcoord = textureCoords[i];
            s_RendererData.QuadVertexDataAdressCopy->TextureID = 1;
            s_RendererData.QuadVertexDataAdressCopy++;
        }
